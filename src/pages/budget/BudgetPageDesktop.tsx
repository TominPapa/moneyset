// BudgetPageDesktop — 데스크톱/패드 예산 화면
    ...
    <div className={styles.page}>
      <div className={styles.topBar}>
        ...
        <div className={styles.topActions}>
          {isPending && (
            <span style={{ fontSize: 12, color: 'var(--gold-400)', marginRight: 12, display: 'flex', alignItems: 'center', gap: 4, animation: 'pulse 1.5s infinite' }}>
              ☁️ 클라우드 동기화 중...
            </span>
          )}
