// SettingsPageDesktop — 데스크톱/패드 설정 화면
    ...
    <div className={styles.tabContent}>
      <div className={styles.section}>
        ...
        <p className={styles.sectionDesc}>
          ...
          실수로 데이터가 손상됐을 때 원하는 날짜로 되돌릴 수 있습니다.
        </p>
        <button
        ...
        {backupLoading ? (
          ...
          <p className={styles.backupEmpty}>저장된 백업이 없습니다. 앱 사용 후 자동 저장됩니다.</p>
        ) : (
        ...
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              title={tabLocked ? '업그레이드가 필요합니다' : undefined}
              type="button"
            >
        ...
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <div className={styles.sectionHeader}>
              ...
              <span style={{ fontSize: 'var(--size-sm)', fontWeight: 700, color: tierColor(userTier) }}>
                {tierLabel(userTier)}
              </span>
            </div>
            {userTier === 'free' ? (
